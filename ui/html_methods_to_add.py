# This file contains the new/updated methods for main_window.py
# These should replace or be added to the MainWindow class

# Method 1: Replace existing _on_export_html (lines 2315-2382)
...
# Method 2: New method - add after _on_export_html
...
# Method 3: New method - add after _generate_coordinates_html_table
...
# Method 4: New method - add after _coord_to_wgs84
...
# Method 5: New method - add after _calculate_bearing
...
# Method 6: New method - add after _azimuth_to_quadrant
